...
[CreateAssetMenu(menuName = "ScriptableObjects/EnemyTypeDictionary")]
public class EnemyTypeDictionary : ScriptableObject
{
    [SerializeField] GenericDictionary<ENEMY_TYPE, GameObject> prefabDictionary;

    public GenericDictionary<ENEMY_TYPE, GameObject> PrefabDictionary { get => prefabDictionary; }
}
