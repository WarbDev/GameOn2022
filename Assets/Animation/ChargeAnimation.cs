...
public class ChargeAnimation : EntityAnimation<ChargeAnimationProperties>
{
    ...
    public override void Play(ChargeAnimationProperties properties)
    {
        ...
        chargeSequence.Append(affectedTransform.DOShakePosition(duration + 1 * intensityScale, new Vector3(strength, strength), vibrato, 90, false, true, ShakeRandomnessMode.Harmonic)).OnComplete(onComplete);
